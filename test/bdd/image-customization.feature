Feature: AxonOpsPlatform components
  ...
  Scenario: Default images are used when no overrides specified
    Given an AxonOpsPlatform CR with no image overrides
  ...
  Scenario: Custom image repository for TimeSeries
    Given an AxonOpsPlatform CR with TimeSeries image "my-registry.com/custom-timeseries"
  ...
  Scenario: Custom image repository for Search
    Given an AxonOpsPlatform CR with Search image "my-registry.com/custom-search"
  ...
  Scenario: Custom image repository for Server
    Given an AxonOpsPlatform CR with Server image "my-registry.com/custom-server"
  ...
  Scenario: Custom image repository for Dashboard
    Given an AxonOpsPlatform CR with Dashboard image "my-registry.com/custom-dash"
  ...
  Scenario: Custom pull policy per component
    Given an AxonOpsPlatform CR with TimeSeries pullPolicy "Always"
  ...
  Scenario: Update image tag triggers rolling update
    Given an AxonOpsPlatform CR with Server tag "2.0.27"
