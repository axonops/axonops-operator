Feature: Enable and disable AxonOpsServer components with resource cleanup
  As an operator user
  I want to enable or disable individual components in AxonOpsServer
  ...
  Scenario: Disable TimeSeries component cleans up all resources
    Given an existing AxonOpsServer CR with spec.timeSeries.enabled set to true
  ...
  Scenario: Disable Search component cleans up all resources
    Given an existing AxonOpsServer CR with spec.search.enabled set to true
  ...
  Scenario: Re-enable disabled TimeSeries component recreates resources
    Given an AxonOpsServer CR with spec.timeSeries.enabled currently set to false
  ...
  Scenario: Disable Server component removes StatefulSet and Services
    Given an existing AxonOpsServer CR with spec.server.enabled set to true
  ...
  Scenario: Disable Dashboard component removes Deployment and Service
    Given an existing AxonOpsServer CR with spec.dashboard.enabled set to true
  ...
  Scenario: Create AxonOpsServer with disabled component on initial creation
