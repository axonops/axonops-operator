Feature: OrgName must always be lowercase
  ...
  Scenario: Mixed-case orgName is normalized to lowercase
    Given an AxonOpsServer CR with spec.server.orgName set to "AxonOps"
  ...
  Scenario: Uppercase orgName is normalized to lowercase
    Given an AxonOpsServer CR with spec.server.orgName set to "MY-ORG"
    When the operator reconciles the AxonOpsServer CR
  ...
  Scenario: Already lowercase orgName is unchanged
    Given an AxonOpsServer CR with spec.server.orgName set to "myorg"
    When the operator reconciles the AxonOpsServer CR
  ...
  Scenario: OrgName with spaces and capitals is normalized
    Given an AxonOpsServer CR with spec.server.orgName set to "My Org Name"
    When the operator reconciles the AxonOpsServer CR
  ...
  Scenario: OrgName normalization persists across reconciliation loops
    Given an AxonOpsServer CR with spec.server.orgName set to "TestOrg"
