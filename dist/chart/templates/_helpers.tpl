...
*/}}
{{- define "axonops-operator.fullname" -}}
...
*/}}
{{- define "axonops-operator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "axonops-operator.resourceName" -}}
{{- $fullname := include "axonops-operator.fullname" .context }}
{{- $suffix := .suffix }}
