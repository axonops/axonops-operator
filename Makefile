...
KIND_CLUSTER ?= axonops-operator-test-e2e
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name axonops-operator-builder
	$(CONTAINER_TOOL) buildx use axonops-operator-builder
...
HELM_NAMESPACE ?= axonops-operator-system
